...
var TailwindTheme = React__default.createContext(defaultTheme);
...
const TailwindThemeProvider = ({
  ...
  return /*#__PURE__*/React__default.createElement(TailwindTheme.Provider, {
    value: mergedTheme
  }, children);
};
...
const withTheme = Component => {
  const WithTheme = props => /*#__PURE__*/React__default.createElement(TailwindTheme.Consumer, null, theme => /*#__PURE__*/React__default.createElement(Component, _extends({}, props, {
    theme: theme
  })));
...
const withTheme$1 = (Component, _ref) => {
  ...
  const WithTransition = componentProps => /*#__PURE__*/React__default.createElement(reactTransitionGroup.Transition, _extends({
    in: get(componentProps, inState),
    timeout: 0
  }, rest), state => /*#__PURE__*/React__default.createElement(Component, _extends({}, componentProps, {
    transition: state
  })));
...
const withTailwind = (Component, {
  ...
  const WithTailwind = (_ref) => {
    ...
    return /*#__PURE__*/React__default.createElement(Component, _extends({}, filterProps(props, tailwindProps.filter(prop => !ignore.includes(prop))), {
...
const Base = (_ref) => {
  ...
  const Component = is;
  return /*#__PURE__*/React__default.createElement(Component, _extends({}, filterProps(rest, tailwindProps), {
...
const Box = (_ref) => {
  ...
  return /*#__PURE__*/React__default.createElement(Base$1, _extends({
    is: el,
    inline: inline,
...
const Image = (_ref) => {
  ...
  }), /*#__PURE__*/React__default.createElement(Base$1, _extends({
    is: is,
    absolute: true,
    pin: true,
    w: "full"
  }, rest)), children && /*#__PURE__*/React__default.createElement(Box, {
    absolute: true,
    pin: true,
    flex: true,
    items: "end"
...
const FillButton = props => /*#__PURE__*/React__default.createElement(Button$1, _extends({}, props, {
  buttonStyle: "fill"
}));
...
const OutlineButton = props => /*#__PURE__*/React__default.createElement(Button$1, _extends({}, props, {
  buttonStyle: "outline"
}));
...
const TextButton = props => /*#__PURE__*/React__default.createElement(Button$1, _extends({}, props, {
  buttonStyle: "text"
}));
...
const LinkButton = props => /*#__PURE__*/React__default.createElement(Button$1, _extends({}, props, {
  buttonStyle: "link"
}));
...
const CardFooter = (_ref) => {
  ...
  return /*#__PURE__*/React__default.createElement(Flex, _extends({
    ...
    reverse: true,
    items: "end"
  }, rest), React__default.Children.map(children, child => React__default.cloneElement(child, {
    rounded: 'none'
  })));
};
...
const Subtitle = props => /*#__PURE__*/React__default.createElement(Title$1, _extends({}, props, {
  subtitle: true
}));
...
const BrandText = (_ref) => {
  ...
  return /*#__PURE__*/React__default.createElement(Paragraph$1, _extends({}, rest, {
    brand: true,
    rounded: theme.radius,
...
const DangerText = props => /*#__PURE__*/React__default.createElement(BrandText$1, _extends({}, props, {
  type: "danger"
}));
...
const InfoText = props => /*#__PURE__*/React__default.createElement(BrandText$1, _extends({}, props, {
  type: "info"
}));
...
const WarningText = props => /*#__PURE__*/React__default.createElement(BrandText$1, _extends({}, props, {
  type: "warning"
}));
...
const ContentTitle = (_ref) => {
  ...
  return /*#__PURE__*/React__default.createElement(Title$1, _extends({
    id: id,
...
class ContentBlock extends React.PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/React__default.createElement(Box, _extends({
      ...
      if (index === React__default.Children.count(children) - 1) {
        return React__default.cloneElement(child, {
          m: {
            b: 0
          }
...
const Article = (_ref) => {
  ...
  return /*#__PURE__*/React__default.createElement(ContentBlock$1, _extends({
    is: is
  }, rest));
};
...
const Footer = (_ref) => {
  ...
  }, rest), /*#__PURE__*/React__default.createElement(Container$1, {
    padding: true
  }, children));
};
...
class Field extends React.PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/React__default.createElement(Box, _extends({
      ...
      maxW: "sm"
    }, filterProps(rest, ['id'])), React__default.Children.map(children, child => React__default.cloneElement(child, {
      field: fieldProps
    })));
  }
...
const ExpandMore = props => /*#__PURE__*/React__default.createElement("svg", _extends({
...
const Select = (_ref) => {
  ...
  }, rest), !!placeholder && /*#__PURE__*/React__default.createElement("option", {
    value: ""
  }, placeholder), options.map(option => /*#__PURE__*/React__default.createElement("option", {
    key: `${name}-${option.value}`,
    value: option.value
  }, option.label))), /*#__PURE__*/React__default.createElement(Box, {
    absolute: true,
    pin: ['y', 'r'],
    flex: true,
    items: "center",
...
class OptionInput extends React.PureComponent {
  constructor(props) {
    super(props);
    const {
      defaultChecked,
  ...
  render() {
    ...
    }, checked && (checkbox ? /*#__PURE__*/React__default.createElement(Box, {
      is: "svg",
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 24 24",
      h: 3,
...
const Radio = props => /*#__PURE__*/React__default.createElement(OptionInput$1, _extends({}, props, {
  checkbox: false
}));

Radio.displayName = "Radio";

const Checkbox = props => /*#__PURE__*/React__default.createElement(OptionInput$1, _extends({}, props, {
  checkbox: true
}));
...
const List = (_ref) => {
  ...
  }, rest), React__default.Children.map(children, child => child && /*#__PURE__*/React__default.createElement(Box, {
    is: listItemIs,
    m: {
...
class OptionList extends React.PureComponent {
  ...
  render() {
    ...
    const isInvalid = field.invalid || invalid;
    return /*#__PURE__*/React__default.createElement(List$1, _extends({
      reset: true,
      m: {
        b: 0
      }
    }, rest), React__default.Children.map(children, child => {
...
const Row = (_ref) => {
  ...
  return /*#__PURE__*/React__default.createElement(Flex, _extends({
    ...
    listReset: true
  }, rest), gutter ? React__default.Children.map(children, child => React__default.cloneElement(child, {
    p: {
      l: gutterSpacing
    },
    m: {
...
class Header extends React.PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/React__default.createElement(Box, _extends({
      ...
      role: "banner"
    }, filterProps(rest, ['id'])), /*#__PURE__*/React__default.createElement(Container$1, {
      is: Flex,
      wrap: true,
      items: "center",
      justify: "between",
      padding: true
    }, React__default.Children.map(children, child => React__default.cloneElement(child, {
      header: headerProps
    }))));
  }
...
const NavItemWrapper = props => /*#__PURE__*/React__default.createElement("li", _extends({
  role: "none"
}, props));
...
const NavMenu = (_ref) => {
  ...
  return /*#__PURE__*/React__default.createElement(Box, _extends({
    ...
    role: "navigation"
  }, responsive.nav, rest), /*#__PURE__*/React__default.createElement(Title$1, {
    level: 2,
    id: headingId,
    visuallyHidden: true
  }, "Site menu"), /*#__PURE__*/React__default.createElement(List$1, _extends({
    reset: true,
    flex: "grow",
    role: "menu",
    listItemIs: NavItemWrapper
  }, responsive.menu, list), React__default.Children.map(children, child => child.type === NavItem$1 && React__default.cloneElement(child, {
    header,
    role: 'menuitem'
  }))), React__default.Children.map(children, child => child.type !== NavItem$1 && child));
};
...
const Bar = () => /*#__PURE__*/React__default.createElement(Box, {
  inlineBlock: true,
  border: "b",
  style: {
...
const NavToggle = (_ref) => {
  ...
  }, responsive, rest), children || /*#__PURE__*/React__default.createElement(Box, {
    flex: [true, 'col'],
    items: "stretch",
    justify: "around",
    h: "full",
    p: 3
  }, /*#__PURE__*/React__default.createElement(Bar, null), /*#__PURE__*/React__default.createElement(Bar, null), /*#__PURE__*/React__default.createElement(Bar, null)));
};
...
const SkipLink = (_ref) => {
  ...
  }, /*#__PURE__*/React__default.createElement(FillButton, _extends({
    is: "a",
    bg: "white",
    text: "black",
    absolute: true,
...
exports.ContentBlock = ContentBlock$1;
...
exports.NavBrand = NavBrand$1;
exports.NavItem = NavItem$1;
exports.NavMenu = NavMenu$1;
exports.NavToggle = NavToggle$1;
exports.List = List$1;
exports.Main = Main;
...
exports.SiteWrap = SiteWrap$1;
exports.Subtitle = Subtitle;
exports.Paragraph = Paragraph$1;
exports.Title = Title$1;
exports.BrandText = BrandText$1;
exports.DangerText = DangerText;
exports.InfoText = InfoText;
exports.WarningText = WarningText;
exports.getColorShade = getColorShade;
exports.getTailwindClassNames = getTailwindClassNames;
exports.tailwindProps = tailwindProps;
exports.propTypes = propTypes;
exports.propVariants = propVariants;
exports.tailwindPropToClassName = tailwindPropToClassName;
exports.withTailwind = withTailwind;
exports.defaultTheme = defaultTheme;
exports.TailwindTheme = TailwindTheme;
exports.TailwindThemeProvider = TailwindThemeProvider;
exports.withTheme = withTheme;
exports.useThemeValue = useThemeValue;
exports.getAsArray = getAsArray;
exports.filterProps = filterProps;
exports.getUniqueID = getUniqueID;
exports.withTransition = withTheme$1;
